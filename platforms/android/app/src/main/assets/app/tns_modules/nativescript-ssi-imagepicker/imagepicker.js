...
var ImagePicker = (function () {
    ...
    Object.defineProperty(ImagePicker.prototype, "assetType", {
        get: function () {
            return this._options && this._options.assetType && this._options.assetType.toLowerCase() === 'video' ? 'video' : 'image';
        },
        enumerable: true,
        configurable: true
    });
    ...
    ImagePicker.prototype.present = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            intent.setType(_this.assetType + "/*");
