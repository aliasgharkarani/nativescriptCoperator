...
export class AuditTrailService {
    ...
    createAuditTrail(auditTrail:AuditTrail ): Observable<any> {
...
headers = headers.append("Content-Type", "application/json");
        ...
        return this.http.post<any>(this.apiUrl + 'auditTrail',JSON.stringify(auditTrail), {responseType: 'json',headers});
    } 
